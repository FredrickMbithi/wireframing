...
## Documentation & Submission (what to include)

When you submit this project in GitHub for manual review, make sure the repository contains:

- `README.md` (this file) with the sections requested by the project tasks.
- Links to any Figma files or exported images used as evidence of wireframes/prototypes. If you created a Figma prototype, include the share link and a short guide to view it.
- Screenshots or exports of low-fidelity and high-fidelity wireframes (optional but recommended).

Manual QA review checklist (request this when you're done):

1. Confirm README.md includes all required sections (Introduction, Key Elements, Types of Wireframes, Tools, Benefits, Practice).
2. Verify Figma prototype links (if applicable) are accessible.
3. Confirm documentation explains which wireframe fidelity was used and why.
4. Ensure any supporting images/screenshots are present in the repo (e.g., `/assets/`).

How to request Manual QA review
...
- Create example wireframes (low-fidelity) and add them under `/wireframing/wireframes/low-fi/` and export at least one high-fidelity frame or Figma prototype under `/wireframing/wireframes/high-fi/`.
- Add Figma share links and a short walkthrough video or GIF demonstrating key interactions.
- Request Manual QA review on the platform and paste the review link in the repo (or in the project submission form).
